...
University of Messina A.Y. 2023/2024 | Industrial IoT Project | Prof: Giovanni Merlino (giovanni.merlino@unime.it)
...
2. Login into your AWS account created before
...
1. Install PyCharm IDE (or another IDE if you prefer) from the following link: https://www.jetbrains.com/pycharm/download/
...
# MQTT - TLS IoT Tool configuration
